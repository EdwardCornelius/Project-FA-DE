                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-4 mx-auto mt-5">
                    <section id="login-body" class="pt-3">
                        <div class="card border-0 shadow pt-3">
                            ...
                            <img src="<?= base_url('assets/img/SMKKristenImmanuel.png') ?>" alt="Logo SMKKristenImmanuel" class="img-fluid mx-auto d-block" width="80">
                                <div class="mt-3">
                                    <span class="card-info text-center"><b>Masuk untuk melakukan absensi</b></span>
                                </div>
                            </div>
                            <div class="card-body">
