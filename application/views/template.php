        ...
        <div class="sidebar" data-image="../assets/img/sidebar-5.jpg" data-color="blue">
            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                    ...
                    <img src="<?= base_url('assets/img/SMKKristenImmanuel.png') ?>" alt="" class="img-fluid" width="80">
                    </a>
                </div>
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link text-white">
                            ...
                            <h6 class="text-center"><label><?= date("y / m / d") ?></label></h6>
                        </a>
                    </li>
                ...
                <div class="container">
                    <nav>
                        <p class="copyright text-center">
                            &copy; 2023 <a href="http://ski.sch.id">SMK Kristen Immanuel</a>
                        </p>
                    </nav>
                </div>
            </footer>
