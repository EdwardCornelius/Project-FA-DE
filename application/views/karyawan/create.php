                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nik" id="nik" class="form-control" placeholder="Masukan NIK Siswa" required="reuqired" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                <label for="nama">Nama Lengkap : </label>
                                <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukan Nama Lengkap Siswa" required="reuqired" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
